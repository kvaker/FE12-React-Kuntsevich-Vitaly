...
const data = [{name: 'Jan', dist: 20, pv: 2400, amt: 2400}, {name: 'Feb', dist: 40, pv: 2000, amt: 1500},
    {name: 'Mar', dist: 20, pv: 2000, amt: 1500}, {name: 'Apr', dist: 80, pv: 2000, amt: 1500},
    {name: 'Jun', dist: 40, pv: 2000, amt: 1500}, {name: 'Jul', dist: 40, pv: 2000, amt: 1500},
    {name: 'Aug', dist: 20, pv: 2000, amt: 1500}, {name: 'Sep', dist: 60, pv: 2000, amt: 1500},
    {name: 'Oct', dist: 60, pv: 2000, amt: 1500}, {name: 'Nov', dist: 20, pv: 2000, amt: 1500},
    {name: 'Dec', dist: 100, pv: 2200, amt: 2200}];

const RenderRunningAxisTick = ({ x, y, payload }) => {
    let path = '';
    ...
    switch (payload.value) {
        ...
        <LineChart width={600} height={300} data={data} margin={{ top: 5, right: 20, bottom: 5, left: 0 }}>
            ...
            <XAxis dataKey="name" tick={RenderRunningAxisTick} />
            <YAxis />
            <Tooltip />
        </LineChart>
    );
    ...
    return (
        <LineChart width={1080} height={200} data={data} margin={{ top: 5, right: 20, bottom: 5, left: 0 }}>
            <defs>
            ...
            <Line type="monotone" dataKey="dist" stroke="#FFA500" />
            <CartesianGrid stroke="#ccc" strokeDasharray="5 5" />
            <XAxis dataKey="name"/>
            <YAxis />
            <Tooltip />
...
export default RenderRunningAxisTick