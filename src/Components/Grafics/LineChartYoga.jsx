...
const data = [{name: 'Jan', dist: 0, pv: 2400, amt: 2400}, {name: 'Feb', dist: 0, pv: 2000, amt: 1500},
    {name: 'Mar', dist: 0, pv: 2000, amt: 1500}, {name: 'Apr', dist: 30, pv: 2000, amt: 1500},
    {name: 'Jun', dist: 40, pv: 2000, amt: 1500}, {name: 'Jul', dist: 60, pv: 2000, amt: 1500},
    {name: 'Aug', dist: 100, pv: 2000, amt: 1500}, {name: 'Sep', dist: 80, pv: 2000, amt: 1500},
    {name: 'Oct', dist: 60, pv: 2000, amt: 1500}, {name: 'Nov', dist: 20, pv: 2000, amt: 1500},
    {name: 'Dec', dist: 0, pv: 2200, amt: 2200}];

const RenderYogaAxisTick = ({ x, y, payload }) => {
    let path = '';
    ...
    const renderLineChart = (
        <LineChart width={600} height={300} data={data} margin={{ top: 5, right: 20, bottom: 5, left: 0 }}>
            ...
            <XAxis dataKey="name" tick={RenderYogaAxisTick} />
            <YAxis />
            <Tooltip />
        </LineChart>
    );
    ...
    return (
        <LineChart width={1080} height={200} data={data} margin={{ top: 5, right: 20, bottom: 5, left: 0 }}>
            <Line type="monotone" dataKey="dist" stroke="#d30491" />
            <CartesianGrid stroke="#ccc" strokeDasharray="5 5" />
            <XAxis dataKey="name"/>
            <YAxis />
            <Tooltip />
...
export default RenderYogaAxisTick